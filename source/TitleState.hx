...
class TitleState extends MusicBeatState
{
	...
	override function update(elapsed:Float)
	{
		...
		if(randomWindowText != 13) {
			...
			Application.current.window.title = "Friday Night Funkin': Demolition Engine - " + randomWindowTitle[13];
